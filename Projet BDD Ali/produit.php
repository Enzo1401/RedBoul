...
// Vérifier si l'utilisateur est connecté et si son ID est celui de l'administrateur (ici 1)
if (isset($_SESSION['id_users']) && $_SESSION['id_users'] == 1) {
    ...
    foreach ($produits as $produit) {
        ...
        <div class='product-card'>
            ...
            <p class='product-price'>" . $produit['prix'] . " €</p>
            <div class='product-actions'>
                <a href='commande.php' class='btnUser'>Commander</a>
            </div>
        </div>";
    }
